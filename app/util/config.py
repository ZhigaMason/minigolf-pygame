...
START_LEVEL_CHOOSING_BTNS_POS = [
    (SCREEN_SIZE[0] // 2 - START_LEVEL_CHOOSING_BTNS_GAP - START_LEVEL_CHOOSING_BTNS_SIZE[0] // 2, SCREEN_SIZE[1] // 2 - 60),
    (SCREEN_SIZE[0] // 2 + START_LEVEL_CHOOSING_BTNS_GAP + START_LEVEL_CHOOSING_BTNS_SIZE[0] // 2, SCREEN_SIZE[1] // 2 - 60),
]

SINGLE_LEVEL_CHOOSING_BTNS_SIZE = 100, 100
SINGLE_LEVEL_CHOOSING_BTNS_GAP = 10
SINGLE_LEVEL_CHOOSING_BTNS_SPACE = 110
SINGLE_LEVEL_CHOOSING_BTNS_POS = SCREEN_SIZE[0] // 2 - 275, 6 * SCREEN_SIZE[1] // 8
